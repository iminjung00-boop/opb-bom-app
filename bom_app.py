...
st.write("BOM의 핵심 제작 사양(BOX, S/W PANEL)과 자재 명세를 분석합니다.")
...
if uploaded_file:
    ...
    if all_tables:
        ...
        target_mask = df.astype(str).apply(lambda x: x.str.contains('BUTTON|버튼|HIP|SJ21|PCB', case=False, na=False)).any(axis=1)
